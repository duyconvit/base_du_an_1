                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <p>We are a team of designers and developers creating high quality websites </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Trinh Van Bo - Nam Tu Liem - Ha Noi</li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">admin@gmail.com </a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2025 <b>shopDunk.</b> Made by <a href="https://hasthemes.com/"><b>shopDunk.</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
